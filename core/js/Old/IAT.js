...
var arCategory = [{'Code':"E",'opta':"entrepreneurs"                                                                           ,'optb':"non-entrepreneurs"},
                  ...
                  {'Code':"Q",'opta':"people with above-average IQs"                                                           ,'optb':"people whose IQs are average or below"},
...
{
	var sGender = $('input:radio[name=subGender]:checked').val();
	if (typeof(sGender)=="undefined") {
		alert("Please provide gender information");
		return;
	}
	gGender = sGender;
	...
	$.get("core/thanks.html", function(data) {
		...
		//resulttext = "<div style='text-align:center;padding:20px'>Thanks for participating! Your confirmation code is " + confCode + "</div>";		
...
function WriteFile()
{
	...
	str += sFirstChr + "," + gGender + "," + gOpinion + "," + gEmailID;
