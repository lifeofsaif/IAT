...
<head>
    ...
    <script src="core/js/experimenterNG.js?version=3"></script>
...
<div ng-show="surveyOrIat=='Survey'">
    ...
    <div ng-show="newOrEdit=='new'">
        ...
        <p>Enter Paragraph</p>
        <textarea ng-model='surveyTemplate.paragraph' ng-change="splitPeas(surveyTemplate)" cols="50"
                  rows="10"></textarea>

        <p>Enter Keywords</p>
        <textarea ng-model='surveyTemplate.keywords' ng-change="splitPeas(surveyTemplate)" cols="50"
                  rows="10"></textarea>

        <p>This is what your paragraph will look like</p>
        <p style="font-size: small; width: 50%">

                <span ng-repeat="word in surveyTemplate.wordArray track by $index">
                    <span ng-repeat="key in word" ng-style="key.style">{{key.word}}</span>
                </span>
    ...
    <div ng-show="newOrEdit=='edit'">
        ...
        <p style="font-size: small; width: 50%">
                    ...
                    <span ng-repeat="word in surveyToEdit.wordArray track by $index">
                        <span ng-repeat="key in word" ng-style="key.style">{{key.word}}</span>
                    </span>
